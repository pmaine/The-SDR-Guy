...
class AirbandAmReceiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Airband AM Receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Airband AM Receiver")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "AirbandAmReceiver")
        ...
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rf_gain_range = qtgui.Range(0, 70, 1, 30, 200)
        ...
        self.top_grid_layout.addWidget(self._rf_gain_win, 3, 0, 1, 3)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_waterfall_sink_x_0_win, 0, 0, 1, 6)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_win, 5, 0, 1, 3)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 5, 3, 1, 3)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_pll_carriertracking_cc_0 = analog.pll_carriertracking_cc((50e-3), (3.272e-5), (1.636e-5))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.sample_rate, 20e3, 5e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tuner, self.sample_rate)
...
def main(top_block_cls=AirbandAmReceiver, options=None):
